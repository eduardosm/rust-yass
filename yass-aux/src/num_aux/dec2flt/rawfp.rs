...
use num_aux::FpCategory::{Infinite, Zero, Subnormal, Normal, Nan};
use num_aux::Float;
    ...
    Self: Float<Bits = <Self as RawFloat>::RawBits>
{
    ...
    type RawBits: Add<Output = Self::RawBits> + From<u8>;
...
impl RawFloat for f32 {
    ...
    fn transmute(self) -> u64 {
        let bits: u32 = unsafe { ::std::mem::transmute(self) };
        bits as u64
    }
...
impl RawFloat for f64 {
    ...
    fn transmute(self) -> u64 {
        let bits: u64 = unsafe { ::std::mem::transmute(self) };
        bits
    }
...
pub fn encode_subnormal<T: RawFloat>(significand: u64) -> T {
    ...
    RawFloat::from_bits(significand)
}
...
pub fn next_float<T: RawFloat>(x: T) -> T {
    match x.classify() {
        ...
        Zero | Subnormal | Normal => {
            RawFloat::from_bits(x.transmute() + 1)
        }
    }
}
